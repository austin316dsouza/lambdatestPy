...
username = "austin_dsouza"
accessToken = "RJ5QnXkccxc9pnjy63MAsd9fBdPTvX1I5o08SESoxB6uaNJkCU"
...
ActionChains(driver).drag_and_drop_by_offset(slider,215, 0).perform()
time.sleep(4)
...
try:
    assert mes == "Please fill out this field."
except AssertionError:
    print("Assertion failed. Actual value is",  mes)

driver.find_element(By.NAME, "name").send_keys("Austin")
driver.find_element(By.CSS_SELECTOR, "#inputEmail4").send_keys("Ozzy@gmail.com")
driver.find_element(By.CSS_SELECTOR, "#inputPassword4").send_keys("ozzy3@16")
driver.find_element(By.CSS_SELECTOR, "#company").send_keys("AustinStocks")
driver.find_element(By.CSS_SELECTOR, "#websitename").send_keys("www.austin.org")

select = Select(driver.find_element(By.XPATH, "/html/body/div[1]/div/section[2]/div/div/div/div/form/div[3]/div[1]/select"))
...
try:
    ...
    print("Success message verified successfully")
except AssertionError:
